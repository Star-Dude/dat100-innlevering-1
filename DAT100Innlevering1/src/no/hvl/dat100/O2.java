...
public class O2 {
    ...
    public static void calculateBracketTax() {
        ...
        if (income < bracket1[1] && income > 208050) {
            taxDecimal = 1.7 / 100;
        ...
        else if (income < bracket5[1]) {
            taxDecimal = 17.6 / 100;
            paidTax = (income - bracket5[0] - 1) * taxDecimal;
            bracket = "trinn 5";
        }
        ...
        if (bracket == null) {
            ...
            System.out.printf("Med en inntekt på %dkr, ligger du på %s med %.1f%% i trinnskatt, og du må betale %.2fkr i skatt.", income, bracket, taxDecimal*100, paidTax);
        }
    }
